...
_THEMES = {
    "Oscuro": """
        ...
        QMenu { background: #111827; color: #e5e7eb; border: 1px solid rgba(148,163,184,0.2); }
        QMenu::item:selected { background: rgba(59,130,246,0.22); }
        ...
        QLabel#CounterLabel {
            ...
            background: rgba(15,23,42,0.6); padding: 4px 12px; border-radius: 12px;
        }
        QFrame#Panel {
        ...
        QTabBar::tab {
            background: rgba(30,41,59,0.92); color: #e5e7eb;
            border: 1px solid rgba(148,163,184,0.18);
            border-top-left-radius: 8px; border-top-right-radius: 8px;
            padding: 6px 16px; margin-right: 2px;
        }
        QTabBar::tab:selected { background: rgba(59,130,246,0.3); border-bottom-color: transparent; }
        QTabBar::tab:hover { background: rgba(51,65,85,0.96); }
        QListWidget {
            background: #111827;
        ...
        QListWidget::item:alternate { background: rgba(30,41,59,0.5); }
