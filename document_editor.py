...
class TextEditorToolbar(QFrame):
    ...
    def add_zoom_controls(self, zoom_out_btn, zoom_in_btn, search_btn, contrast_btn=None):
        ...
        if contrast_btn is not None:
            row.insertWidget(stretch_idx + 3, contrast_btn)
